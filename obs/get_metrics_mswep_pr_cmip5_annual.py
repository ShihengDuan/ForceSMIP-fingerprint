...
mswep = mswep.bounds.add_missing_bounds(axes=['T'])
mswep = mswep.temporal.group_average('__xarray_dataarray_variable__', freq='year')
...
mswep_anomaly = mswep-mswep.mean(dim='time')
mswep_stand = mswep_anomaly/mswep_anomaly.std(dim='time')
...
if not os.path.exists('/p/lustre2/shiduan/ForceSMIP/EOF/modes_all/'+str(eof_start)+'_2022_annual_cmip5/MSWEP/'):
    os.makedirs('/p/lustre2/shiduan/ForceSMIP/EOF/modes_all/'+str(eof_start)+'_2022_annual_cmip5/MSWEP/')
p = '/p/lustre2/shiduan/ForceSMIP/EOF/modes_all/'+str(eof_start)+'_2022_annual_cmip5/MSWEP/'
