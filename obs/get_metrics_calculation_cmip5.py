...
path = '/p/lustre2/shiduan/ForceSMIP/EOF/modes_all/'+str(eof_start)+'_2022_cmip5/'+variable+'-CMIP-metrics-stand-False-month-True-unforced-False'
if late:
    path = path+'-late'
if n_mode>1:
...
path = '/p/lustre2/shiduan/ForceSMIP/EOF/modes_all/'+str(eof_start)+'_2022_cmip5/'+variable+'-CMIP-metrics-stand-True-month-True-unforced-False'
if late:
    path = path+'-late'
if n_mode>1:
    path = path+'-n_mode-'+str(n_mode)
...
path = '/p/lustre2/shiduan/ForceSMIP/EOF/modes_all/'+str(eof_start)+'_2022_cmip5/'+variable+'-CMIP-metrics-stand-False-month-False-unforced-False'
if late:
    path = path+'-late'
if n_mode>1:
    path = path+'-n_mode-'+str(n_mode)
...
path = '/p/lustre2/shiduan/ForceSMIP/EOF/modes_all/'+str(eof_start)+'_2022_cmip5/'+variable+'-CMIP-metrics-stand-True-month-False-unforced-False'
if late:
    path = path+'-late'
if n_mode>1:
    path = path+'-n_mode-'+str(n_mode)
